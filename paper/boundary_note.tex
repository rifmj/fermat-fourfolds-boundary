...
full statements and proofs in \cite{BNeven})}. The even census finds thirty-eight primitive
beyond-machinery orbits through degree $250$ ($21$ at $m\le108$, beginning at $m=50$ --- the odd
law ``survivor $\Rightarrow3\mid m$'' fails in the even sector --- then $14$ through $200$ and
$3$ more through $250$). Iterated partition certificates of the
...
$m=168$ falls under Aoki's published Theorem~0.1(i) \cite{Aoki00} ($168=2^3\cdot3\cdot7$ has
his degree form; the bridge to the Fermat varieties is quoted in Appendix~\ref{app:aoki},
where two verified errata of the printed text are also recorded), and the isolated degree-$210$
...
\cite[Thm.~2.1]{Aoki00}), all outside the degree forms of Aoki's theorem --- in the three walls
$W_{70},W_{110},W_{114}$.
...
independent census at anchor levels, the level-summary cross-check on a fresh sub-range, and the
direct brute-force generator on every census level through $m=45$ ---
in seconds on the reference machine whose measured runtimes the ancillary README reports;
...
chain; no claim in this paper rests on it. This manuscript was prepared with AI assistance; all
