...
\S\ref{sec:closures}, never the partition oracle; the restriction is a proved no-op for every
verdict reported here --- an exhaustive sweep over all forty classes and every prime $p\ge7$
dividing their level finds no closure by such a block at depth $\le2$, nor at depth $\le3$ for
the residual ten (receipt in the ancillary). The \emph{deep tiers} add depth $k\le5$ and \emph{iteration}: a
...
$70$ & $(1,20,24,42,61,62)$ & open, $W_{70}$ & $138$ & $(1,22,57,63,135,136)$ & iterated\\
